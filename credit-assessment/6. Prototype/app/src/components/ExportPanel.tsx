  ...
  return (
    <Card>
      ...
      <div className="grid grid-cols-2 gap-6 mb-6">
        <div>
          <div className="text-xs font-mono uppercase text-[var(--muted)] mb-2">Contents (FR10.1)</div>
        ...
        <div>
          <div className="text-xs font-mono uppercase text-[var(--muted)] mb-2">Stamped for reconstructability (FR10.2)</div>
          ...
          <p className="text-sm">No redaction applied — decided, not open (NFR Personal data). Enterprise-level controls, not a workflow-application concern.</p>
        </div>
      </div>
