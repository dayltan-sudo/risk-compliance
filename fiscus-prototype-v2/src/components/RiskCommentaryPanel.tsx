...
import { ModelGeneratedBadge, Badge } from "./Badge.js";
  ...
  return (
    <Card>
      ...
      {commentary && commentary.noObservations && (
        <p className="text-sm text-[var(--muted)]">No observations for this assessment — a positive result, not a missing one.</p>
      )}
