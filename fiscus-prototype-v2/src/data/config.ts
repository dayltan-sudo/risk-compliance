import type { CriterionNumberAll, PresentationScale, StandardFieldName, StatementSection } from "../types.js";
...
export const EXTRACTION_MODEL_VERSION = "deepseek-v4.1-flash@opencode-go";
