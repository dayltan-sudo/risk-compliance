import type { ExtractedField, IntegrityCheckName, IntegrityCheckResult, OperandMovement, StandardFieldName } from "../types.js";
import { INTEGRITY_TOLERANCE_PCT } from "../data/config.js";
import { fieldPeriodChange } from "./ratios.js";
