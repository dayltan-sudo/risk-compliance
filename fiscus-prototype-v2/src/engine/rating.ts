import type { CriterionDriver, CriterionInput, CriterionNumberAll, ExtractedField, Rating, RatingClass, RelationshipType, Ratio } from "../types.js";
import { RATING_CLASSES, SCORECARD, SCORECARD_VERSION } from "../data/config.js";
