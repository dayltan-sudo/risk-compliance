...
import { assessmentsForCustomerDivision, customerDivisionPairs, mostRecentApprovedClass } from "../store/selectors.js";
    ...
    <div>
      <div className="flex items-start justify-between mb-6">
        <SectionHeading
          ...
          dek="One row per (customer, division) pair with at least one assessment — the same customer appears once per division that has assessed them. Read-only."
        />
        <Link to="/start">
