# Salus — MVP Build Phase Plan

Agent names per `2. Agents & Workflows/`: Salus Orchestrator, RiskScanner, Insurance DocAnalyst, CoverageAnalyst, InsuranceCustodian.

## MVP 1.1 — Foundation
| Component | Function |
| :--- | :--- |
| Salus Orchestrator | Chat interface, prompt iteration (sandbox — not yet grounded on live data) |
...
| Component | Function |
| :--- | :--- |
| Salus Orchestrator | Alerts & Notification (MVP triggers: Renewal due, Low-confidence extraction, Contractual requirement gap, Exclusion conflict) |
