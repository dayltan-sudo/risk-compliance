...
>
> **Companion docs:** trigger context — [`Alerts & Notification.md`](Alerts%20%26%20Notification.md). Redaction guardrail — [`../d. Reference/Salus Reference - RBAC & Access Scoping.md`](../d.%20Reference/Salus%20Reference%20-%20RBAC%20%26%20Access%20Scoping.md). Output shapes — [`../c. State/Salus - Output Templates.md`](../c.%20State/Salus%20-%20Output%20Templates.md).
...
| :--- | :--- | :--- |
| `salus_generate_report` | Reporting & Export | On demand or scheduled |
| `salus_get_lineage` | Salus Assistant Orchestrator, Reporting & Export | Record ID in scope (audit lineage output) |
| `salus_write_audit` | Every component | Every export |
