# Salus — Output Templates

> Reference doc. Worked, illustrative output examples for the twelve Salus components — other docs link into a section here (`#anchor`) rather than repeating a filled-in example inline. All data below is illustrative placeholder data; no Keppel-specific figures are assumed or implied, consistent with the PRD's own disclaimer (front matter).
>
> **Companion docs:** [`Salus - Google ADK State Reference.md`](Salus%20-%20Google%20ADK%20State%20Reference.md) · [`Salus - Data Lifecycle & Versioning Reference.md`](Salus%20-%20Data%20Lifecycle%20%26%20Versioning%20Reference.md)

## Salus Assistant Answer

Two variants: a grounded answer with citations (FR8.4), and the no-answer fallback (FR8.5). Produced by Salus Assistant Orchestrator on Answer Convergence (State Reference).
