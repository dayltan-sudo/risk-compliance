# Salus Reference — Extraction Field Set

Reproduces PRD §8.2's policy data dictionary verbatim. Used by [`Field Extraction & Validation Routing.md`](../a.%20Agents/Field%20Extraction%20%26%20Validation%20Routing.md) to define what `salus_extract_fields` must extract and score, and by [`Enrichment & Posting.md`](../b.%20Workflows/Enrichment%20%26%20Posting.md) to know which fields carry a field-level source-location pointer (FR3.6) once posted.
