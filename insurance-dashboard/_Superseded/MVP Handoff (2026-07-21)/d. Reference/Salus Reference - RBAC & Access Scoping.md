# Salus Reference — RBAC & Access Scoping
...
>
> **Companion docs:** access-scope gate — [`Salus Assistant Orchestrator.md`](../a.%20Agents/Salus%20Assistant%20Orchestrator.md)§8. State schema — [`Salus - Google ADK State Reference.md`](../c.%20State/Salus%20-%20Google%20ADK%20State%20Reference.md). Audit read access — [`Audit & Access Log.md`](../b.%20Workflows/Audit%20%26%20Access%20Log.md).
...
`app:user_scope_registry` is integration-sourced (Entra ID / SSO), application-scoped, persistent — the authoritative record of each user's role and assigned entity/site, provisioned outside Salus. Three readers only: **Salus Assistant Orchestrator** (access gate), **Reporting & Export**, **Audit & Access Log**. No component writes to it.
